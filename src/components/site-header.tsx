...
export function SiteHeader() {
  ...
  return (
    <header
      className={`flex min-h-[64px] items-center justify-between gap-2 rounded-2xl border px-3 py-2 transition-all duration-700 sm:h-[76px] sm:px-5 lg:px-8 ${
        dark
    ...
    >
      <Link
        href="/"
        className="relative flex h-11 w-[118px] shrink-0 items-center justify-start overflow-hidden sm:h-12 sm:w-[150px]"
      >
        <Image
      ...
      <div className="flex min-w-0 items-center gap-2 sm:gap-3 lg:gap-4">
        ...
        <button
          ...
          className={`relative h-10 w-14 shrink-0 rounded-xl border transition-all duration-700 sm:h-11 sm:w-16 ${
            dark
        ...
        <Link
          href="/cart"
          className={`relative flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border transition-all duration-300 sm:h-11 sm:w-11 ${
            dark
        ...
        {authUser ? (
          <div className="flex items-center gap-2">
            <Link
              ...
              title={accountLabel}
              className={`flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border text-sm font-bold transition-all duration-300 sm:h-11 sm:w-11 ${
                dark
                  ? "border-white/10 bg-white/[0.03] text-white hover:border-blue-500/40 hover:bg-blue-500/10"
                  : "border-black/10 bg-white text-[#07111f] hover:border-blue-500/40 hover:bg-blue-50"
              }`}

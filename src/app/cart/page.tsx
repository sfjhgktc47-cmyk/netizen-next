...
export default function CartPage() {
 ...
 <Link
 href={productHref}
 className="soft-box relative flex h-[62px] items-center justify-center overflow-hidden rounded-2xl bg-slate-50 text-[10px] text-muted-soft sm:h-[110px] md:h-[140px] md:text-sm"
 >
 {item.image ? (
 ...
 loading="lazy"
 className="h-full w-full object-contain p-1.5 mix-blend-multiply sm:p-2"
 />
 ) : (
 "Фото"
 )}
...
function ProductStrip({
 ...
 >
 <div className="soft-box flex h-[108px] items-center justify-center overflow-hidden rounded-2xl bg-slate-50 text-xs text-muted-soft sm:h-[150px] sm:text-sm">
 {product.image ? (
 // eslint-disable-next-line @next/next/no-img-element
 <img
 src={product.image}

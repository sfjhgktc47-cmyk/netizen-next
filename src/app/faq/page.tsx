...
export default function FaqPage() {
 ...
 className="absolute left-5 right-5 top-5 z-30 cursor-pointer rounded-[24px] border border-blue-500/45 bg-[var(--card)] p-5 ring-1 ring-blue-500/10 md:left-7 md:right-7 md:top-7 md:p-6"
 >
 <div className="flex items-start justify-between gap-4">
